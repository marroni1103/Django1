...
SECRET_KEY = 'edz2s#m^0exo=xnbxd&_pb-*@4t!_iw-a!+vsyw2=6=)!r6$!('

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG modo TRUE - modo desenvolvimento
# DBUG modo FALSE - modo producao (publicada)
DEBUG = False

ALLOWED_HOSTS = ['django1-gmp.herokuapp.com/']
